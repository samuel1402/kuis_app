...
class BackgroundDecoration extends StatelessWidget {
  final Widget child;
  final bool showGardient;

  const BackgroundDecoration(
      {Key? key, required this.child, this.showGardient = false})
      : super(key: key);
      ...
      children: [
        Positioned.fill(
          ...
          decoration: BoxDecoration(
              color: showGardient ? null : Theme.of(context).primaryColor,
              gradient: showGardient ? mainGradient() : null),
          child: CustomPaint(
